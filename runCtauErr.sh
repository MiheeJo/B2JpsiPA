...
#datasetarr=(datasets)
datasetarr=(/afs/cern.ch/work/m/miheejo/private/cms442_Jpsi/src/pA/datasets/pPb18.38nb/)
#datasetarr=(/afs/cern.ch/work/m/miheejo/private/cms442_Jpsi/src/pA/datasets/Pbp4.65nb/)
prefixarr=(default_bit1_singleMuEtaAll default_bit1_singleMuEtaAllMu4GeV default_bit1_singleMuEtaBarrel default_bit1_mu4GeV)
...
#raparr=(-2.4--1.757 -1.757--1.113 -1.113--0.47 -0.47-0.173 0.173-0.817 0.817-1.46)
