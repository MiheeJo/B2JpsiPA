...
int main(int argc, char* argv[]) {
  ...
  int cent801235Arr[] = {0,1,2,4,6,8,10,12,15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60,65,70,75,80,100};
  ...
  } else if (centInput == 801235) {
    int arrSize = sizeof(cent801235Arr)/sizeof(int);
    for (int i=0; i<arrSize; i++) centLimits.push_back(cent801235Arr[i]);
  } else if (centInput == 1) {
