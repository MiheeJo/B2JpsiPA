...
int main (int argc, char* argv[]) {
  ...
  string ptbins[] = {"0.0-30.0","3.0-30.0","6.5-30.0","0.0-3.0","3.0-5.0","5.0-6.5","6.5-8.0","8.0-10.0","10.0-13.0","13.0-18.0","18.0-30.0","10.0-30.0","0.0-1.0","1.0-2.0","2.0-3.0"};
  string ptbinscorser[] = {"0.0-30.0","3.0-30.0","6.5-30.0"};
  string ptbinsfiner[] = {"0.0-1.0","1.0-2.0","2.0-3.0","0.0-3.0","3.0-5.0","5.0-6.5","6.5-8.0","8.0-10.0","10.0-13.0","13.0-18.0","18.0-30.0","10.0-30.0"};
//  vector<string> ptbins(ptbinsfiner+ptbinscorser,);
  ...
  string centbins[] = {"0-100","0-20","20-60","10-60","0-10","10-20","20-30","30-60"};
  string centbinscorser[] = {"0-100","10-60"};
  string centbinsfiner[] = {"0-10","10-20","20-30","30-60","0-20","20-60"};
  ...
  string dphibins[] = {"0.000-1.571","0.000-0.393","0.393-0.785","0.785-1.178","1.178-1.571"};
  ...
  for (int rapbin=0; rapbin < nRaps; rapbin++) {
    for (int ptbin=0; ptbin < nPt; ptbin++) {
      ...
      // if finer |y| or y binnings are used, pick up only ptcorser, centcorser
      ...
      // skip centfiner if pT is ptfiner
      if ( find(ptVectorFiner.begin(), ptVectorFiner.end(), prange)!=ptVectorFiner.end() && find(centVectorFiner.begin(), centVectorFiner.end(), crange)!=centVectorFiner.end() ) continue;
